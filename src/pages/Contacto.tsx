...
const contactInfo = [
  ...
  { label: "Nombre", value: "DEHESA SAN ISIDRO" },
  { label: "Registro", value: "SEMARNAT-UMA-IN-0061-GTO" },
];

export default function Contacto() {
  return (
    <main>
      <HeroBanner title="Contáctanos" image={heroCacti} height="h-64" />
      ...
      <section className="bg-section-alt py-20">
        <div className="max-w-5xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col items-center">
            <div className="border-4 border-primary rounded-full w-64 h-40 flex flex-col items-center justify-center shadow-lg">
              <span className="font-serif text-6xl font-bold text-dsi-brown">DSI</span>
              <span className="text-xs tracking-[0.3em] uppercase text-dsi-brown mt-1">Dehesa San Isidro</span>
            </div>
            <p className="mt-8 text-center text-muted-foreground text-sm leading-relaxed max-w-xs">
